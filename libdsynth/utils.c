...
static void write_block2(int16_t *pcm, void *args, bnr_t *bnr, void (write_note)(int16_t*, void *, note_t*, uint32_t)){
...
void write_block(int16_t *pcm, void *args, bnr_t *bnr, void (write_note)(int16_t*, void *, note_t*, uint32_t)){
